        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-card text-card-foreground p-6 rounded-xl border shadow-sm flex items-center justify-between">
                    <div>
                        <p className="text-sm font-medium text-muted-foreground">Tổng số Job</p>
                        <h3 className="text-3xl font-bold text-foreground mt-2">{stats.totalJobs}</h3>
                        <p className="text-xs text-muted-foreground mt-1">Công việc trên hệ thống</p>
                    </div>
                ...
                <div className="bg-card text-card-foreground p-6 rounded-xl border shadow-sm flex items-center justify-between">
                    <div>
                        <p className="text-sm font-medium text-muted-foreground">Job đang tuyển</p>
                        <h3 className="text-3xl font-bold text-green-600 mt-2">{stats.activeJobs}</h3>
                        <p className="text-xs text-muted-foreground mt-1">Vị trí đang mở</p>
                    </div>
                ...
                <div className="bg-card text-card-foreground p-6 rounded-xl border shadow-sm flex items-center justify-between">
                    <div>
                        <p className="text-sm font-medium text-muted-foreground">Đơn ứng tuyển</p>
                        <h3 className="text-3xl font-bold text-foreground mt-2">{stats.totalApplications}</h3>
                        <p className="text-xs text-muted-foreground mt-1">Tổng số hồ sơ nhận được</p>
                    </div>
                ...
                <div className={`bg-card text-card-foreground p-6 rounded-xl border shadow-sm flex items-center justify-between ${stats.pendingApplications > 0 ? 'ring-1 ring-orange-200 bg-orange-50/30' : ''}`}>
                    <div>
                        <p className="text-sm font-medium text-muted-foreground">Đang chờ duyệt</p>
                        <h3 className={`text-3xl font-bold mt-2 ${stats.pendingApplications > 0 ? 'text-orange-600' : 'text-foreground'}`}>
                            {stats.pendingApplications}
                        </h3>
                        <p className="text-xs text-muted-foreground mt-1">Hồ sơ cần xem xét</p>
                    </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-bold text-foreground">Đơn ứng tuyển mới nhất</h2>
