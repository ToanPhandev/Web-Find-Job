    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="container mx-auto px-6 py-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight text-gray-900">FindJob</span>
        </div>
      ...
      <main className="flex-1 flex flex-col justify-center items-center text-center px-4 relative overflow-hidden">
        ...
        <div className="max-w-3xl space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-700">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            ...
            <Link href="/login">
              <Button size="lg" className="h-14 px-8 text-lg rounded-full bg-blue-600 hover:bg-blue-700 shadow-xl shadow-blue-200 transition-transform hover:scale-105">
                Tìm Việc Ngay <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
          </div>

          <div className="pt-12 flex flex-wrap justify-center gap-8 text-sm font-medium text-gray-500">
